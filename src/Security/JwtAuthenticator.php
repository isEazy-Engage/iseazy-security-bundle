...
class JwtAuthenticator extends AbstractAuthenticator implements AuthenticationEntryPointInterface
{
    ...
    private const JWKS_CACHE_TTL = 300;
    ...
    private function validateToken(\stdClass $decoded): void
    {
        ...
        if ($decoded->iss !== $expectedIssuer) {
            ...
            throw new UnexpectedValueException(
                sprintf('Invalid issuer. Expected: %s, got: %s', $expectedIssuer, $decoded->iss)
            );
        }
    }
    ...
    {
        return $this->cache->get(self::JWKS_CACHE_KEY, function (ItemInterface $item) {
